...
import com.mop.base.app.AppActivityManager
...
internal object CrashHandlerUtil : UncaughtExceptionHandler {
    ...
    private fun formatLogInfo(ex: Throwable): String {
        ...
        sb.append("appVerCode:").append(AppUtil.versionCode).append(lineSeparator) // 系统版本
    ...
    private fun handleException(ex: Throwable) {
        try {
            FileOutputStream(
                CRASH_LOG_PATH + DateUtil.formatYMDHMS() + ".log", true
            ).use { outputStream ->
